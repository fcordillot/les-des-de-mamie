<template>
  <img class="lddm-image-lazy-load"
       ref="img"
    ...
    computed: {
      imgClass () {
        return {
          ...
          'lddm-image-lazy-load--is-animating': this.isAnimating,
          'lddm-image-lazy-load--is-reveal': this.isReveal
        }
      },
...
<style lang="scss" scoped>
  .lddm-image-lazy-load {
    ...
    &.lddm-image-lazy-load--is-reveal {
      opacity: 1;
    }
  }
</style>
