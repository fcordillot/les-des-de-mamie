<template>
  <div class="lddm-image-lazy-load"
       :class="containerClass"
       :style="{backgroundColor: `${bcgColor}`}"
       v-observe-visibility="visibilityOpts">
    <lddm-image-lazy-load-item v-if="canLoadImage"
                                :maxWidth="maxWidth"
                                :klass="klass"
                                :animation="animation"
...
<script>
  ...
  // Components
  import LDDMImageLazyLoadItem from '@/components/media/LDDMImageLazyLoadItem'
   ...
   */
  export default {
    name: 'LDDMImageLazyLoad',

    mixins: [visibilityMixin],

    components: {
      'lddm-image-lazy-load-item': LDDMImageLazyLoadItem
    },
    ...
    computed: {
      containerClass () {
        return {
          ...
          'lddm-image-lazy-load__container--reveal': this.imgIsReveal
        }
      }
    },
...
<style lang="scss" scoped>
  .lddm-image-lazy-load__container {
    display: flex;
    ...
    &.lddm-image-lazy-load__container--reveal {
